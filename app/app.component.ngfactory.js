...
import * as import13 from '../../app/nav/nav.component';
import * as import14 from './nav/nav.component.ngfactory';
...
export var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this.compView_1 = new import14.View_NavComponent0(this.viewUtils, this, 1, this._el_1);
        this._NavComponent_1_3 = new import14.Wrapper_NavComponent();
        this.compView_1.create(this._NavComponent_1_3.context);
        this._text_2 = this.renderer.createText(parentRenderNode, '\n	', null);
        this._el_3 = import3.createRenderElement(this.renderer, parentRenderNode, 'div', new import3.InlineArray2(2, 'class', 'container'), null);
        this._text_4 = this.renderer.createText(this._el_3, '\n    ', null);
        this._el_5 = import3.createRenderElement(this.renderer, this._el_3, 'router-outlet', import3.EMPTY_INLINE_ARRAY, null);
        this._vc_5 = new import15.ViewContainer(5, 3, this, this._el_5);
        this._RouterOutlet_5_5 = new import16.Wrapper_RouterOutlet(this.parentView.injectorGet(import17.RouterOutletMap, this.parentIndex), this._vc_5.vcRef, this.parentView.injectorGet(import18.ComponentFactoryResolver, this.parentIndex), null);
    ...
    View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import13.NavComponent) && (1 === requestNodeIndex))) {
